...
for t in $@; do
  ...
  echo "=== ${t} ==="
  if [ -e "/var/www/html/dapp-auction/contracts/solana/program/target/rls/debug/build/jemalloc-sys-f254c05fd2143925/out/jemalloc/${t}.sh" ] ; then
    ...
    enable_fill=1 \
    enable_prof=0 \
    . /var/www/html/dapp-auction/contracts/solana/program/target/rls/debug/build/jemalloc-sys-f254c05fd2143925/out/jemalloc/${t}.sh && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /var/www/html/dapp-auction/contracts/solana/program/target/rls/debug/build/jemalloc-sys-f254c05fd2143925/out/jemalloc/ /var/www/html/dapp-auction/contracts/solana/program/target/rls/debug/build/jemalloc-sys-f254c05fd2143925/out/build/
  else
    export MALLOC_CONF= && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /var/www/html/dapp-auction/contracts/solana/program/target/rls/debug/build/jemalloc-sys-f254c05fd2143925/out/jemalloc/ /var/www/html/dapp-auction/contracts/solana/program/target/rls/debug/build/jemalloc-sys-f254c05fd2143925/out/build/
